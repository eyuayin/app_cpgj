...
<html lang="en" >
    ...
    <body>
        <header>
            <h2>会员信息导入</h2>
            <a class="stuts"><span>天环瑜伽</span></a>
        </header>
        <div class="container">
            <div class="contr"><h2>请选择会员信息的excel文件(.xlsx或.xls文件)</h2></div>

            <div class="upload_form_cont">
                <form id="upload_form" enctype="multipart/form-data" method="post" action="upload_member_be.php">
                    <div>
                        <div><label for="image_file">请选择会员信息文件</label></div>
