...
<?php
    ...
    $query_result = $conn->query("select member_id,card_id from member_info_table_cui where member_name='".$input_name."'");
    debug_output("select member_id,card_id from member_info_table_cui where member_name='".$input_name."'");
    ...
    foreach($result as $value)
    {
        ...
        $query = $conn->query("select class_id,canceled from class_booking_table_cui where member_id=$value[0] order by class_id");
        debug_output("select class_id,canceled from class_booking_table_cui where member_id=$value[0] order by class_id");
