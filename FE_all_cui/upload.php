...
<?php
    ...
    { 
        ...
        $query_result = $conn->query("select class_name from class_info_table_cui where class_begin_time='".$begin_time."' and location=$location_num and classroom=$class_room_num");
        ...
        {
            $conn->query("insert into class_info_table_cui (class_name,class_begin_time,class_end_time,location,classroom,teacher,max_user_number,class_priority) values ('".$class_name."','".$begin_time."','".$end_time."',$location_num,$class_room_num,'".$teacher."',$capacity,$priority)");
