			...
			<form class="form-horizontal" action="add_class.php" method="post" >
				<fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                           <select style="line-height:35px;" id="location" name="location" class="dropdown-select"  required="required"> <option value="2">君子兰</option></select>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                             <select style="line-height:35px;" id="classroom" name="classroom" class="dropdown-select" required="required">
                               <option value="" selected="">请选择教室</option>
                                   ...
                                   <option value="3">一楼VIP</option>
                                   <option value="4">二楼VIP-1</option>
                                   <option value="5">二楼VIP-2</option>
                                   <option value="6">二楼VIP-3</option>
                             </select>
                        </div>
                    </div>
                    <div class="control-group">
