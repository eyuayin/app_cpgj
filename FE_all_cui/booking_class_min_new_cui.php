                ...
                <div class="row-fluid">
                    <div class="page-header">
                     ...
                     <div class="ui-widget" style="margin-bottom:23px;">		  
		                <button class="btn-large" data-toggle="modal" data-target="#otherClass" data-whatever="@mdo">点击此处新增小班课程</button>
                     </div>
                     <div>
...
foreach ($rs as $value) 
    {
                    ...
                    echo "  <td>{$value[4]}</td>";  //classroom
                    echo "<td>";
                    echo "<button class='btn-info' data-toggle='modal' data-target='#insertMeb' data-whatever='@mdo'>新增</button>";
                    echo "</td>";
                    echo "</tr>";
                    echo "</tbody>";                    
    }
		  ...
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  <div class="modal-header">
				...
				<h4 class="modal-title" id="otherLabel">新增小班课</h4>
			  </div>
			  ...
			  <div class="modal-footer">
				...
				<button type="button" class="btn btn-primary" onClick="insertConfirm();">确定</button>
			  </div>
			</div>
		  </div>
		</div>
       ...
       <div class="modal fade" id="insertMeb" tabindex="-1" role="dialog" aria-labelledby="otherLabel">
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  ...
			  <div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
				<button type="button" class="btn btn-primary" onClick="insertMebConfirm();">确定</button>
			  </div>
			</div>
		  </div>
		</div>
