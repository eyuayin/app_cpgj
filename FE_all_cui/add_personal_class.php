...
<?php
    ...
    //从class_info_table_cui中查出新增课程当天的所有课程
    $query_result = $conn->query("select class_name,class_begin_time,class_end_time,location,classroom from class_info_table_cui where class_begin_time like '".$new_class_date."%'");
    debug_output("select class_name,class_begin_time,class_end_time,location,classroom from class_info_table_cui where class_begin_time like '".$new_class_date."%'");
    ...
    //如果没有冲突，则加入到personal_class_info_table_cui
    $query_result = $conn->query("insert into personal_class_info_table_cui(class_name,class_begin_time,class_end_time,location,classroom,teacher,max_user_number,class_priority) values('".$input_class_name."','".$input_begin_time."','".$input_end_time."',$input_location,$input_classroom,'".$input_teacher."',$input_max_user,3)");
    debug_output("insert into personal_class_info_table_cui(class_name,class_begin_time,class_end_time,location,classroom,teacher,max_user_number,class_priority) values('".$input_class_name."','".$input_begin_time."','".$input_end_time."',$input_location,$input_classroom,'".$input_teacher."',$input_max_user,3)");
    if(!$query_result)
    {
