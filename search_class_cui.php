        ...
        <div class="container-fluid">
         ...
         <a class="brand" href="#"> 翠屏国际馆会员管理系统 </a>
          <div class="btn-group pull-right">
			<a class="btn" href="FE_all_cui/my-profile.html"><i class="icon-user"></i> Admin</a>
            ...
            <ul class="dropdown-menu">
              ...
              <!--<li class="divider"></li>-->
              <li><a href="FE_all_cui/destroy.php">Logout</a></li>
            </ul>
          </div>
          <div class="nav-collapse">
            <ul class="nav">
             <li class="dropdown"><a href="FE_all_cui/index.php" class="dropdown-toggle" >首页</a>
			  </li>
              ...
              <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">预约管理 <b class="caret"></b></a>
                ...
                <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">课程管理 <b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                        <li><a href="FE_all_cui/upload_class.php" target="_blank">导入本月课程</a></li>
                        <!--<li class="divider"></li>-->
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">精品课管理 <b class="caret"></b></a>
                    <ul class="dropdown-menu">                        
                        <li><a href="FE_all_cui/booking_class_min_new.php">精品课新建及预约</a></li>
                       
                    </ul>
                </li>
				 <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">私教管理 <b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <li><a href="FE_all_cui/booking_class_private_new.php">私教预约</a></li>
                    </ul>
                </li>
