<?php
	...
	else  //翠屏会馆课程查询
	{
			...
			*/
			...
			$st = $conn->query("select class_begin_time,class_name,class_id from class_info_table_cui where class_begin_time between '".$get_day_begin_time."' and '".$get_day_end_time."'");
