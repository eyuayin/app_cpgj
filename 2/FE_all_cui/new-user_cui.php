			...
			<form class="form-horizontal" action="add_member.php" method="post">
				<fieldset>
                    ...
                    <div class="control-group" >
                        ...
                        <div class="controls">
                            <select style="line-height:35px;" id="select_card_type" name="card_type" class="dropdown-select" onchange="card_type_change()"><option value="" selected="">请选择类型</option><option value="年卡" selected="selected">年卡</option><option value="年卡(不限次)" selected="selected">年卡(不限次)</option><option value="半年卡" selected="">半年卡</option><option value="季卡" selected="">季卡</option><option value="月卡" selected="">月卡</option><option value="学期周卡" selected="">学期周卡</option><option value="学期次卡" selected="">学期次卡</option><option value="次卡" selected="">次卡</option></select>
                        </div>
                    </div>
