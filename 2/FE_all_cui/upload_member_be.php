...
<?php
    ...
    { 
        ...
        $query_result = $conn->query("select card_id from member_info_table_cui where card_id='".$card_id."'");
        ...
        {
            $conn->query("insert into member_info_table_cui (member_name,sex,identy_card_number,phone,card_id,card_type,remarks) values ('".$name."','".$sex_english."','".$ID."','".$phone."','".$card_id."',$card_type_num,'".$note."')");
            //echo "insert into class_info_table_cui (class_name,class_begin_time,class_end_time,location,classroom,teacher,max_user_number,class_priority) values ('".$class_name."','".$begin_time."','".$end_time."',$location_num,$class_room_num,'".$teacher."',$capacity,$priority)";
            $success_num++;
        }
    }
