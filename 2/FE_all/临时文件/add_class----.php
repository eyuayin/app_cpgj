...
<?php
    ...
    //如果没有冲突，则加入到数据库中
    $query_result = $conn->query("insert into class_info_table(class_name,class_begin_time,class_end_time,location,classroom,teacher_id,max_user_number,class_priority) values($input_class_name,'".$input_begin_time."','".$input_end_time."',$input_location,$input_classroom,$input_teacher_id,$input_max_user,$input_class_priority)");
    debug_output("insert into class_info_table(class_name,class_begin_time,class_end_time,location,classroom,teacher_id,max_user_number,class_priority) values($input_class_name,'".$input_begin_time."','".$input_end_time."',$input_location,$input_classroom,$input_teacher_id,$input_max_user,$input_class_priority)");
    if(!$query_result)
    {
