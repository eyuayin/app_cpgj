...
<?php
    ...
    if($card_type == 1)  //计时卡
    {
        //更新time_card_table_cui中信息
        $affect_rows = $conn->exec("update time_card_table_cui set card_id='".$input_cardNo."',card_priority='".$input_card_priority."',max_times=$input_total_times,valid_begin_date='".$input_begin_date."',valid_end_date='".$input_end_date."',pause_begin_date='".$input_frozen_date."',pause_end_date='".$input_unfrozen_date."',card_status='".$input_card_status."',concrete_card_type=$input_concrete_cardType where card_id='".$input_former_card_id."'");
        debug_output("update time_card_table_cui set card_id='".$input_cardNo."',card_priority='".$input_card_priority."',max_times=$input_total_times,valid_begin_date='".$input_begin_date."',valid_end_date='".$input_end_date."',pause_begin_date='".$input_frozen_date."',pause_end_date='".$input_unfrozen_date."',card_status='".$input_card_status."',concrete_card_type=$input_concrete_cardType where card_id='".$input_former_card_id."'");
    ...
    {
        //更新measured_card_table_cui中信息
        $affect_rows = $conn->exec("update measured_card_table_cui set card_id='".$input_cardNo."',card_priority='".$input_card_priority."',used_times=$input_used_times,max_times=$input_total_times,valid_begin_date='".$input_begin_date."',valid_end_date='".$input_end_date."',pause_begin_date='".$input_frozen_date."',pause_end_date='".$input_unfrozen_date."',card_status='".$input_card_status."',concrete_card_type=$input_concrete_cardType where card_id='".$input_former_card_id."'");
        debug_output("update measured_card_table_cui set card_id='".$input_cardNo."',card_priority='".$input_card_priority."',used_times=$input_used_times,max_times=$input_total_times,valid_begin_date='".$input_begin_date."',valid_end_date='".$input_end_date."',pause_begin_date='".$input_frozen_date."',pause_end_date='".$input_unfrozen_date."',card_status='".$input_card_status."',concrete_card_type=$input_concrete_cardType where card_id='".$input_former_card_id."'");
        if($conn->errorCode() != '00000')
        {
            echo "会员信息修改失败！请保存截图并发给瑜伽馆工作人员，谢谢！";
            //echo "课程信息修改失败！请保存截图并发给瑜伽馆工作人员，谢谢！";
